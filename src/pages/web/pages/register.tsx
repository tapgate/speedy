                        ...
                        <div className="w-full h-[75%] flex justify-center items-center overflow-hidden">
                            <div className="w-full grid grid-rows-8 grid-cols-1 gap-y-6">
                                ...
                                <div className="relative form-control w-full">
                                        <label className={`label pointer-events-none absolute inset-0 px-4 ${'top-[-100%] text-xs'}`}>
                                            <span className="bg-tapgate-white px-1">Email</span>
                                        </label>
                                        <input className="w-full text-sm input input-bordered focus:outline-0" type="text" name="email" onChange={(e) => setEmail(e.target.value)} />
                                    </div>
                                    <div className="relative form-control w-full">
                                        <label className={`label pointer-events-none absolute inset-0 px-4 ${'top-[-100%] text-xs'}`}>
                                            <span className="bg-tapgate-white px-1">Username</span>
                                        </label>
                                        <input className="w-full text-sm input input-bordered focus:outline-0" type="text" name="username" onChange={(e) => setUsername(e.target.value)} />
                                    </div>
                                    <div className="relative form-control w-full">
                                        <label className={`label pointer-events-none absolute inset-0 px-4 ${'top-[-100%] text-xs'}`}>
                                            <span className="bg-tapgate-white px-1">Password</span>
                                        </label>
                                        <input className="w-full text-sm input input-bordered focus:outline-0" type="password" name="password" onChange={(e) => setPassword(e.target.value)} />
                                    </div>
                                    <div className="relative form-control w-full">
                                        <label className={`label pointer-events-none absolute inset-0 px-4 ${'top-[-100%] text-xs'}`}>
                                            <span className="bg-tapgate-white px-1">Password Confirm</span>
                                        </label>
                                        <input className="w-full text-sm input input-bordered focus:outline-0" type="password" name="passwordConfirm" onChange={(e) => setPasswordConfirm(e.target.value)} />
                                    </div>
                                </div>
                                <div className="flex flex-wrap gap-y-4">
                                    {/* Register Button */}
                                    <div className="form-control w-full">
                                        <button className="w-full text-sm btn btn-primary" onClick={() => register(email, username, password, passwordConfirm)}>Register</button>
                                    </div>
